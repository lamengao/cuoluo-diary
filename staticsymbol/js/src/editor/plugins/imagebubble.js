...
goog.provide('cld.edtor.plugins.ImageBubble');
goog.provide('cld.edtor.plugins.ImageBubble.Action');
 ...
 * @param {...!cld.edtor.plugins.ImageBubble.Action} var_args List of
 *     extra actions supported by the bubble.
 * @constructor
 * @extends {goog.editor.plugins.AbstractBubblePlugin}
 */
cld.edtor.plugins.ImageBubble = function(var_args) {
  goog.base(this);

  /**
   * List of extra actions supported by the bubble.
   * @type {Array.<!cld.edtor.plugins.ImageBubble.Action>}
   * @private
   */
...
goog.inherits(cld.edtor.plugins.ImageBubble,
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.LINK_TEXT_ID_ = 'tr_link-text';
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.TEST_LINK_SPAN_ID_ = 'tr_test-link-span';
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.TEST_LINK_ID_ = 'tr_test-link';
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.CHANGE_LINK_SPAN_ID_ = 'tr_change-link-span';
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.CHANGE_LINK_ID_ = 'tr_change-link';
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.DELETE_LINK_SPAN_ID_ = 'tr_delete-link-span';
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.DELETE_LINK_ID_ = 'tr_delete-link';
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.LINK_DIV_ID_ = 'tr_link-div';
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.prototype.stopReferrerLeaks_ = false;
 ...
 */
cld.edtor.plugins.ImageBubble.prototype.stopReferrerLeaks = function() {
...
/** @inheritDoc */
cld.edtor.plugins.ImageBubble.prototype.getTrogClassId = function() {
  return 'ImageBubble';
};


/** @inheritDoc */
cld.edtor.plugins.ImageBubble.prototype.getBubbleTargetFromSelection =
 ...
 */
cld.edtor.plugins.ImageBubble.prototype.setTestLinkUrlFn = function(func) {
 ...
 * @protected
 */
cld.edtor.plugins.ImageBubble.prototype.getTargetUrl = function() {
...
/** @inheritDoc */
cld.edtor.plugins.ImageBubble.prototype.getBubbleType = function() {
  return goog.dom.TagName.A;
};


/** @inheritDoc */
cld.edtor.plugins.ImageBubble.prototype.getBubbleTitle = function() {
  return goog.ui.editor.messages.MSG_LINK_CAPTION;
};


/** @inheritDoc */
cld.edtor.plugins.ImageBubble.prototype.createBubbleContents = function(
    bubbleContainer) {
  ...
  if (goog.editor.Link.isLikelyEmailAddress(linkObj.linkText) ||
    ...
    this.createLink(cld.edtor.plugins.ImageBubble.TEST_LINK_ID_,
  ...
  var changeLinkSpan = this.createLinkOption(
      cld.edtor.plugins.ImageBubble.CHANGE_LINK_SPAN_ID_);
  this.createLink(cld.edtor.plugins.ImageBubble.CHANGE_LINK_ID_,
  ...
  var removeLinkSpan = this.createLinkOption(
      cld.edtor.plugins.ImageBubble.DELETE_LINK_SPAN_ID_);
  this.createLink(cld.edtor.plugins.ImageBubble.DELETE_LINK_ID_,
      MSG_LINK_BUBBLE_REMOVE, this.deleteLink_, removeLinkSpan);

  this.onShow();

  var bubbleContents = this.dom_.createDom(goog.dom.TagName.DIV,
      {id: cld.edtor.plugins.ImageBubble.LINK_DIV_ID_},
 ...
 * @protected
 */
cld.edtor.plugins.ImageBubble.prototype.testLink = function() {
 ...
 */
cld.edtor.plugins.ImageBubble.prototype.isInvalidUrl = goog.functions.FALSE;
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.prototype.getLinkToTextObj_ = function() {
  var isError;
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.prototype.showLinkDialog_ = function() {
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.prototype.deleteLink_ = function() {
 ...
 * @override
 */
cld.edtor.plugins.ImageBubble.prototype.onShow = function() {
  var linkDiv = this.dom_.getElement(
      cld.edtor.plugins.ImageBubble.LINK_DIV_ID_);
  if (linkDiv) {
    var testLinkSpan = this.dom_.getElement(
        cld.edtor.plugins.ImageBubble.TEST_LINK_SPAN_ID_);
    if (testLinkSpan) {
 ...
 * @private
 */
cld.edtor.plugins.ImageBubble.prototype.getTestLinkAction_ = function() {
  var targetUrl = this.getTargetUrl();
 ...
 * @constructor
 */
cld.edtor.plugins.ImageBubble.Action = function(spanId, linkId, message,
    toShowFn, actionFn) {
  this.spanId_ = spanId;
  this.linkId_ = linkId;
