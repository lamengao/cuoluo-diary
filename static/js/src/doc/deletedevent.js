/**
 * @fileoverview The event object dispatched when the doc deleted.
 *
 */


goog.provide('cld.doc.DeletedEvent');
...
/**
 * Event object dispatched when the doc deleted.
 * @param {goog.ui.tree.BaseNode} node The new node.
 * @constructor
 * @extends {goog.events.Event}
 */
cld.doc.DeletedEvent = function(node) {
...
goog.inherits(cld.doc.DeletedEvent, goog.events.Event);
